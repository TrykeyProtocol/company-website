      ...
      <div className="container mx-auto  px-4 md:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
        <div className="flex flex-col items-center justify-between gap-8 lg:gap-12">
          ...
          >
            ...
            {/* Asset Icons */}
            {[
              { src: "/images/landing/printer.webp", alt: "Printer", position: "top-0 left-0" },
              { src: "/images/landing/tricycle.webp", alt: "Tricycle", position: "bottom-0 left-0" },
              { src: "/images/landing/sewing.jpg", alt: "Sewing Machine", position: "top-0 right-0" },
              { src: "/images/landing/generator.jpg", alt: "Generator", position: "bottom-0 right-0" }
            ].map((item, index) => (
              <motion.div
                key={index}
                ...
                transition={{ delay: 0.5 + index * 0.2, duration: 0.5, ease: "easeOut" }}
              >
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-lightMode-text-heading dark:text-darkMode-text-heading">
              ...
              <span className="text-lightMode-text-accent dark:text-darkMode-text-accent italic">not prayers</span>
            </h1>
            <p className="text-lg md:text-xl mb-8">
              Trykey is making use of{" "}
              <span className="text-lightMode-text-accent dark:text-darkMode-text-accent">
                robotics, artificial intelligence and blockchain
              </span>{" "}
              to help investors track the income generated by their physical
              assets in any location world wide
            </p>
            <motion.div
